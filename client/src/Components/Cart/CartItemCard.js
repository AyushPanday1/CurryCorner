...
//remove qty by 1
    function minusItem(proId,userid,cartid){
        ...
        axios.put(`http://localhost:3001/users/${userid}/cart`,object)
          .then((res) => {
            ...
            <div className="items-info">
              ...
              <div className="cart-change">
                <i
                  ...
                  onClick={() => minusItem(element.productId._id,userData.userId._id,cartId)}
                ></i>
                <input type="text" className="qty" placeholder={element.quantity} disabled />
                <i
                  className="fas fa-plus add"
                  onClick={() => plusItem(element.productId._id,userData.userId._id,cartId)}
                ></i>
              </div>
              <div className="price">
              ...
              <div className="remove-item">
                <i
                  ...
                  onClick={() => dltItem(element.productId._id,userData.userId._id,cartId,element.productId.title)}
                ></i>
              </div>
